...
async function main() {
    const _ = process.env;
    const HOST = _.REACT_APP_HOST;
    const PORT = _.REACT_APP_PORT;
    const USER = _.REACT_APP_USERNAME;
    const PASS = _.REACT_APP_PASSWORD;
    const FROM = `"${_.FROM_NAME}" <${_.FROM_EMAIL}>`;
    const TO = `"${_.TO_NAME}" <${_.TO_EMAIL}>`;
    const SUBJECT = "Test email";
    const TEXTVERSION = "text version, test";
    const HTML = `
    <!doctype html>
    <html>
    <head>
    ...
    console.log(FROM, TO, SUBJECT, TEXTVERSION);
  ...
  let info = await transporter.sendMail({
    ...
    text: TEXTVERSION, // plain text body
    html: HTML, // html body
  });
